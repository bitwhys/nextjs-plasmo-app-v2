...
const tabs = [
  { name: 'Saved', href: '#', count: '2', current: true },
  { name: 'Applying', href: '#', count: '4', current: false },
  { name: 'Applied', href: '#', count: '6', current: false },
  ...
  return (
    <>
      <div className="min-h-full">
        {/* Navbar */}
        <Disclosure as="nav" className="bg-canvas">
          {({ open }) => (
            <>
        ...
        {/* Page heading */}
        <header className="bg-canvas py-8">
                            ...
                            >
                              {({ selected, active }) => (
                                <div className="flex flex-col">
                                  ...
                                  <p className={clsx(active ? 'text-purple-200' : 'text-gray-500', 'mt-2')}>
                                    {option.description}
                                  </p>
                                </div>
                              )}
